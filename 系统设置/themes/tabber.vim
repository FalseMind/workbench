...
function! s:initialize_highlights() "{{{2
  ...
  " 整个区域颜色
  execute 'highlight TabLineFill cterm=NONE ctermfg=244 ctermbg=235 gui=NONE guifg=#FF0000 guibg=#5F5F5F'
  " 序号颜色
 ...
 " 默认标签的颜色
  execute 'highlight TabLineDefaultLabel ctermfg=143 ctermbg=235 guifg=#FC5EEB guibg=#FF0000'
